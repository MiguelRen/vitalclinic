...
<div class="w-full h-screen">
    ...
    <div class="w-full mt-4">
        <div class="bg-blue-500 border-2 border-white rounded-md mb-4 w-fit px-4 mx-auto">
            <h1 class="text-2xl font-bold text-white text-center">REGISTRAR FALLA</h1>
        </div>
...
<div>
    ...
    <script type="module" src="http://192.168.0.164/vitalclinic/views/assets/js/api.js"></script>
    <script type="module" src="http://192.168.0.164/vitalclinic/views/assets/js/almacen/fallas/fallas_pedidos_p.js"
        type="module"></script>