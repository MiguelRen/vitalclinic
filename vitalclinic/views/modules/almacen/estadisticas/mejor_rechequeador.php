...
<div class="w-full h-screen">
    ...
    <div class="lg:w-[90%] mx-auto mt-12">
        ...
        <div class="lg:w-[70%] h-[300px] border-2 border-gray-300 rounded-md bg-gray-100 overflow-y-auto relative mt-8 mx-auto">
            <table class="w-full h-600 table-auto border-separate border border-slate-400 rounded-md">
                <thead class="sticky top-0 z-10">
                    <th class="border-2 border-black-500 text-white bg-gray-400 w-36">Rechequeador</th>
                    <th class="border-2 border-black-500 text-white bg-gray-400">T. Pedidos Rechequeados</th>
                    <th class="border-2 border-black-500 text-white bg-gray-400 w-32">Porc. P. Rechequeados</th>
                </thead>
        ...
        <div class="lg:w-[70%] border-2 border-gray-300 rounded-md bg-gray-100 flex justify-center gap-x-4 h-12 mt-4 mx-auto">
            <div class="font-medium text-center  px-4">Cantidad total de pedidos: <p id="total_pedidos">0</p></div>
...
<template id="template_body_table_pedidos">
    <tr class="tr hover:bg-gray-200">
        ...
        <td class="t_p_rechequeados border-2 border-black-500 text-black text-center w-24"></td>
        <td class="porc_p_r border-2 border-black-500 text-black text-center"></td>
    </tr>
</template>

<script src="http://192.168.0.164/vitalclinic/views/assets/js/api.js"></script>
<script src="http://192.168.0.164/vitalclinic/views/assets/js/almacen/estadisticas/mejor_rechequeador.js" type="module"></script>