...
const extraer_datos_confirmar = async (form_data) => {
  try {
    const response = await app(
      "http://192.168.0.164/vitalclinic/controllers/almacen/pedidos/pedidos.php?consult_confirm_pedido=1",
      "POST",
      form_data
    );
...
const confirmar_pedido = async (form_data) => {
  try {
    const response = await app(
      "http://192.168.0.164/vitalclinic/controllers/almacen/pedidos/pedidos.php?confirmar_pedido=1",
      "POST",
      form_data
    );
