        ...
        <div class="lg:w-[70%] h-[300px] border-2 border-gray-300 rounded-md bg-gray-100 overflow-y-auto relative mt-8 mx-auto">
            <table class="w-full h-600 table-auto border-separate border border-slate-400 rounded-md">
                <thead class="sticky top-0 z-10">
                    ...
                    <th class="border-2 border-black-500 text-white bg-gray-400">T. fallas</th>
                    <th class="border-2 border-black-500 text-white bg-gray-400 w-32">Porc. fallas</th>
                </thead>
...
<script src="http://192.168.0.164/vitalclinic/views/assets/js/almacen/estadisticas/fallas_despachador.js" type="module"></script>