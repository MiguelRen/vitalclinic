            ...
            <div class="w-72 flex flex-col gap-y-2">
                ...
                <form class="flex flex-col items-center py-4 h-fit border-2 border-gray-200 rounded-md bg-blue-500">
                    <label for="lastname" class="w-full relative px-6">
                        ...
                        <select name="empleado" id="empleado"  autocomplete="on"  class="w-full border-2 border-gray-300 rounded-md p-2 px-4 pt-2 my-1 font-extralight text-black-500 font-medium text-base focus:outline-none"></select>
                    </label>
                </form>
