    ...
    <div class="w-full mt-4 flex flex-col gap-y-4">
        ...
        <form class="flex items-center w-[420px] border-2 border-gray-200 rounded-md bg-blue-500 py-2 mx-auto">
            <label for="cedula" class="w-full relative px-6">
                ...
                <input type="number" name="cod_pedido" id="cod_pedido" placeholder="Ingrese el Número de Pedido:"
...
<script type="module" src="http://localhost/vitalclinic/views/assets/js/almacen/pedidos/consultar_pedido.js" type="module"></script>