...
<div class="w-full h-screen">
    ...
    <template id="template_body_table_pedidos_d_r_e">
        <tr class="tr hover:bg-gray-200">
           ...
           <td>
               <button class="w-full border-2 border-gray-300 rounded-md px-6 py-2 mt-3 mb-2 font-extralight text-white text-base font-medium focus:outline-none cursor-pointer bg-blue-600">Confirmar</button>
           </td>
        </tr>
